...
# This file is based on the Megatron source code.
# 
...
class IndexedDatasetBuilder(object):
    ...
    def add_item(self, tensor):
        ...
        self.data_offsets.append(self.data_offsets[-1] + bytes /
                                 self.element_size)
...
class MMapIndexedDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        if isinstance(idx, (int, np.integer)):
            ...
            raise TypeError("Unexpected type received for idx: {}".format(
                type(idx)))
